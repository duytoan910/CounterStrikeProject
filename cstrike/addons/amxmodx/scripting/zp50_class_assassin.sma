...
public plugin_init()
{
	...
	cvar_assassin_speed = register_cvar("zp_assassin_speed", "2.00")
...
public zp_fw_core_infect_post(id, attacker)
{
	...
	// assassin glow
	if (get_pcvar_num(cvar_assassin_glow)){
		new R; R=get_pcvar_num(cvar_assassin_aura_color_R)
		new G; G=get_pcvar_num(cvar_assassin_aura_color_G)
		new B; B=get_pcvar_num(cvar_assassin_aura_color_B)
