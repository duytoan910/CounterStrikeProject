...
new const zclass1_bombmodel[] = {
	"models/zombie_plague/v_zombibomb_boomer_zombi.mdl"
}
...
// ==== Dead Explode Effect 
new
const death_exp_effect_model[] = "models/zombie_plague/ef_boomer.mdl"
new
const death_exp_effect_model2[] = "models/zombie_plague/ef_poison03.mdl"
new
const death_exp_effect_sprite[] = "sprites/ef_boomer_ex.spr"
new
const death_exp_effect_sprite2[] = "sprites/spr_boomer.spr"
new
const death_exp_effect_sound[] = "zombie_plague/boomer_death.wav"
...
stock get_speed_vector(const Float: origin1[3],
...
stock play_weapon_anim(player, anim) {
	...
	message_begin(MSG_ONE, SVC_WEAPONANIM, {
		0,
		0,
		0
	}, player)
