...
#define V_MODELA "models/v_infinityex2.mdl"
#define P_MODEL "models/p_infinityex2.mdl"
#define W_MODEL "models/w_infinityex2.mdl"
...
new g_OldWeapon[33], g_Clip[33], g_di_event, g_ShellId, g_ham_bot
...
public Message_DeathMsg(msg_id, msg_dest, id)
{
	...
	if(get_user_weapon(iAttacker) == CSW_DI)
	{
		if(Get_BitVar(g_Had_DualInfinity, iAttacker))
			set_msg_arg_string(4, "infinityex2")
	}
...
{
    register_native("dinfinity", "native_give_sfpistol", 1)
}
public native_give_sfpistol(id)
{
	Get_DualInfinity(id)
}
...
public Event_CurWeapon(id)
{
	...
	{
		set_pev(id, pev_viewmodel2, V_MODELA)
...
public Weapon_Attack(id)
{
	...
	{	
		...
		if(!Get_BitVar(g_InSpecialShoot, id))
			...
			set_weapon_anim(id, DI_ANIM_SP_LEFT1)
		make_shell(id, 0)
		...
		if(!Get_BitVar(g_InSpecialShoot, id))
			...
			set_weapon_anim(id, DI_ANIM_SP_RIGHT1)
		make_shell(id, 1)
...
public fw_Weapon_Reload_Post(ent)
{
	...
	{ // Reload
		...
		Player_SetAnimation(id, "ref_reload_dualpistols")
...
public fw_Weapon_PrimaryAttack_Post(Ent)
{
	...
	{	
		Check_Recoil(id, 0)
		Player_SetAnimation(id, "ref_shoot_dualpistols")
	} else {
		Check_Recoil(id, 1)
		Player_SetAnimation(id, "ref_shoot2_dualpistols")
	}
}
...
public fw_Item_AddToPlayer_Post(ent, id)
{
	...
	if(pev(ent, pev_impulse) == WEAPON_SECRETCODE)
	{
		...
		if(Get_BitVar(g_Had_DualInfinity, id) && (CSWID == CSW_DI))
		{
			set_pev(id, pev_viewmodel2, V_MODELA)
			set_pev(id, pev_weaponmodel2, P_MODEL)
