...
public Draw_BG(id)
{
	...
	md_drawimage(id, 17, 0, hud[0], 0.5,	0.0,	1, 0, 255, 255, 255, 255, 0.0, 0.0, 0.0, ALIGN_NORMAL)
	md_drawimage(id, 18, 0, hud[1], 0.5,	0.02,	1, 0, 255, 255, 255, 255, 0.0, 0.0, 0.0, ALIGN_NORMAL)
	md_drawimage(id, 19, 0, hud[2], 0.5,	0.01,	0, 0, 255, 255, 255, 255, 0.0, 0.0, 0.0, ALIGN_RIGHT)	
	md_drawimage(id, 20, 0, hud[3], 0.5,	0.01,	0, 0, 255, 255, 255, 255, 0.0, 0.0, 0.0, ALIGN_NORMAL)
}
public remove_bg(id)
{
