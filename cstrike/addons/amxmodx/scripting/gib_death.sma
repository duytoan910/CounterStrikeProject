...
g_p_Cvar_GibType,g_p_Cvar_GibSpread,g_p_Cvar_GibCount,g_p_Cvar_GibLife,g_bot
...
public plugin_init()
{
	...
	g_p_Cvar_GibLife = register_cvar("gib_life","15")
...
{
	RegisterHamFromEntity(Ham_Killed, id, "HamHook_Player_Killed_Post")
}
