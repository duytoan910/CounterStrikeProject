...
public plugin_init()
{
	register_plugin("[ZP] Extra: HK416", "1.0", "Crock / =) (Poprogun4ik) / LARS-DAY[BR]EAKER / Fartik:D")
	...
	/*
	cvar_dmg_hk416 = register_cvar("zp_hk416_dmg", "2")
	cvar_recoil_hk416 = register_cvar("zp_hk416_recoil", "0.75")
	cvar_clip_hk416 = register_cvar("zp_hk416_clip", "30")
	cvar_spd_hk416 = register_cvar("zp_hk416_spd", "1.0")
	cvar_hk416_ammo = register_cvar("zp_hk416_ammo", "180")
	*/
	
	//g_itemid_hk416 = zp_register_extra_item("[As. Rifle] \rHK416", 14, ZP_TEAM_HUMAN)
...
public plugin_precache()
{
	...
	register_clcmd("weapon_hk416", "weapon_hook")	
...
{
	register_native("hk416", "native_give_weapon_add", 1)
}
